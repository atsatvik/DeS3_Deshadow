...
class SelfShadow:
    ...
    def get_loaders(self, parse_patches=True, validation="UIUC"):
        print("=> evaluating UIUC test set...")
        train_dataset = ShadowDataset(
            dir=os.path.join(self.config.data.data_dir, "data", "UIUC"),
