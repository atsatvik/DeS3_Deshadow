...
class LRSS:
    ...
    def get_loaders(self, parse_patches=True, validation="LRSS"):
        print("=> evaluating LRSS test set...")
        train_dataset = ShadowDataset(
            dir=os.path.join(self.config.data.data_dir, "data", "LRSS"),
...
class ShadowDataset(torch.utils.data.Dataset):
    ...
    def get_images(self, index):
        ...
        gt_name = self.gt_names[index][:-9] + "_noshad.jpg"
